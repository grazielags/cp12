"""
Faça um programa que leia dois valores para as variáveis A e B e efetue a
...
Apresentar (escreva) os valores trocados. (Note que para haver a troca antes
de serem trocados os valores, um deles deverá ser armazenado em outro local
