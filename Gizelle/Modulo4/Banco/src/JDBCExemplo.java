...
public class JDBCExemplo {
	...
	private static void removerlivro(Connection conexao) throws SQLException {
		...
		if (stmt.executeUpdate() > 0) {
			...
			JOptionPane.showMessageDialog(null, "Livro não existe na base!");
		}
		stmt.close();
	}
	...
	private static void cadastrarlivro(Connection conexao) throws SQLException {
		...
		int ano_edicao = Integer.parseInt(JOptionPane.showInputDialog("Digite o ano de edição do livro"));
	...
	private static void consultarlivro(Connection conexao) throws SQLException {
		String nome = JOptionPane.showInputDialog("Digite parte do nome do livro que deseja buscar");
		...
		while (lista.next()) {
			...
			saida.append("\nAno Edição: " + lista.getString("ano_edicao"));
			saida.append("\n\n");
		}
